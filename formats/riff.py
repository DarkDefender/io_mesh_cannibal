...
class Riff(KaitaiStruct):
    ...
    class Chunk(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.len_data_slot = self._io.read_u4le()
            self._raw_data_slot = self._io.read_bytes(self.len_data_slot)
            ...
            self.pad_byte = self._io.read_bytes((self.len_data_slot % 2))
    ...
    class ChunkType(KaitaiStruct):
        ...
        def chunk_data(self):
            ...
            if _on == Riff.Fourcc.list:
                ...
                self._m_chunk_data = Riff.ByteList(io, self, self._root)
            io.seek(_pos)
            return getattr(self, '_m_chunk_data', None)
